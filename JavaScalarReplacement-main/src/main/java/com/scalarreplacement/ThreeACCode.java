...
import static com.scalarreplacement.BasicScalarReplacement.declaredScalars;
...
//    String typeName;
//    try {
//        typeName = resolvedType.asReferenceType().getTypeDeclaration().get().getName();
...
//    }
//
//    String currentClassName = fieldAccessExpr.findAncestor(ClassOrInterfaceDeclaration.class)
//            .map(ClassOrInterfaceDeclaration::getNameAsString)
//            .orElse("");
//
//    String fieldName = fieldAccessExpr.getNameAsString();
//    String replacementVarName = fieldName;
//    if (!typeName.equals(currentClassName)) {
//        replacementVarName = typeName + "_" + fieldName;
//    }
//
//    NameExpr replacement = new NameExpr(replacementVarName);
...
//}
        ...
        public Visitable visit(FieldAccessExpr fieldAccessExpr, Void arg) {
            ...
            if (scope instanceof NameExpr) {
                ...
                String scalarName = scopeName + "_" + field.asString();

                if (declaredScalars.contains(scalarName)) {
                    NameExpr replacement = new NameExpr(scalarName);
                    fieldAccessExpr.replace(replacement);
                    return replacement;
                }
            }

            // If not replaced, visit normally
            super.visit(fieldAccessExpr, arg);
            return fieldAccessExpr;
        }
